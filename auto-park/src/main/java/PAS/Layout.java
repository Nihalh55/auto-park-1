...
public class Layout{
    ...
    private long int    total_number_of_cars;                   //holds the number of cars in total over a timeline
    private long int    total_number_of_days;                   //holds the number of days since the start of the implementation f the software on the Layout
